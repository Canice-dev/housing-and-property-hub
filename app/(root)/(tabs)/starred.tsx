  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50">
      <View className="px-5 pt-4 pb-3">
        <Text className="text-2xl font-bold text-gray-900">Starred</Text>
        {!loading && (
          ...
          ListEmptyComponent={
            <View className="flex-1 items-center justify-center py-24">
              <View className="w-20 h-20 bg-red-50 rounded-full items-center justify-center mb-4">
                <Ionicons name="star" size={36} color="#EF4444" />
              </View>
              <Text className="text-gray-700 text-lg font-bold mb-1">
                No starred properties
              </Text>
              <Text className="text-gray-400 text-sm text-center px-8">
                Tap the star icon on any property to save it here
              </Text>
              <TouchableOpacity
